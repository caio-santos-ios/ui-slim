        ...
        <>
            {pagination.data.length > 0 && (
                <div className="px-5 py-3 bg-[var(--surface-bg)] border-t border-[var(--surface-border)] flex items-center justify-between text-sm text-[var(--text-muted)] rounded-b-xl">
                    <p className="text-xs">
                        Mostrando <span className="font-semibold text-[var(--text-primary)]">{pagination.totalPages}</span> de{" "}
                            ...
                            <button
                                ...
                                className={`w-8 h-8 rounded-lg text-xs font-semibold transition-all ${
                                    currentPage === i + 1
                                        ...
                                        : "bg-[var(--surface-card)] text-[var(--text-secondary)] border border-[var(--surface-border)] hover:border-[var(--primary-color)] hover:text-[var(--primary-color)]"
                                }`}
                                style={{ padding: 0, height: "2rem", minWidth: "2rem" }}
                            >
                                {i + 1}
                            </button>
                        ))}

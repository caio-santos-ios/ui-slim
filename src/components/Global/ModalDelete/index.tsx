        ...
        <Dialog open={isOpen} as="div" className="relative z-999 focus:outline-none" onClose={() => setIsOpen(false)}>
            <div className="fixed inset-0 z-50 overflow-y-auto" style={{ background: "rgba(0,15,35,.6)", backdropFilter: "blur(5px)" }}>
                <div className="flex min-h-full items-center justify-center p-4">
                    <DialogPanel className="w-full max-w-sm bg-(--surface-card) rounded-2xl border border-(--surface-border) shadow-xl overflow-hidden transition-all duration-300 data-closed:scale-95 data-closed:opacity-0">
                        {/* Header */}
                        <div className="px-5 py-4 border-b border-(--surface-border) flex items-center gap-3"
                            ...
                            <div className="w-8 h-8 rounded-lg bg-[rgba(239,68,68,.2)] flex items-center justify-center shrink-0">
